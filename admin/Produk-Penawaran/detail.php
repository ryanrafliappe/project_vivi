<div class="container-fluid">
    ...
    $hargaaslii = number_format($hargaasli, 0, ',', '.');
    $hargaterbilang = terbilang($hasilcekharga['harga']) . " rupiah";
    ?>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="?page=produk-penawaran-detail-add" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php if ($hasilcek['status_log'] == 'Menunggu Invoice') : ?>
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?= number_format($harga) ?>" readonly class="form-control" id="exampleInputPassword1">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Terbilang</label>
                                                    <input type="text" name="terbilang" class="form-control" id="exampleInputPassword1">
                                                </div>
                                        ...
                                        <?php elseif ($hasilcek['status_log'] == 'Menunggu Surat Penawaran Harga') : ?>
                                            <div class="form-group">
                                ...
                                while ($data = $get->fetch_assoc()) :
                                    ...
                                    <?php elseif ($data['jenis_surat'] == 'INVOICE') : ?>
                                        <tr>
                                            <td class="align-middle text-uppercase"><?= $data['jenis_surat'] ?></td>
                                            <td class="text-center">
                                                <a href="Produk-Penawaran/invoice.php?id=<?= $data['id'] ?>&terbilangs=<?= $data['terbilang'] ?>&hargas=<?= $data['harga'] ?>&logcode=<?= $data['log_code'] ?>" class="btn btn-outline-primary" target="_blank"><i class="fas fa-info-circle"></i></a>
                                            </td>
                                        </tr>
                                    <?php else : ?>
                                        <tr>
