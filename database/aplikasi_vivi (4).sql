...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Mar 2021 pada 15.23
...
INSERT INTO `chat` (`id_chat`, `pengirim`, `penerima`, `pesan`, `date`) VALUES
(2, 'novitadwicendaniraya@gmail.com', 'admin', 'tes', '2021-03-29 21:13:19'),
(3, 'admin', 'novitadwicendaniraya@gmail.com', 'tes', '2021-03-29 21:15:26'),
(4, 'novitadwicendaniraya12@gmail.com', 'admin', 'admin hey', '2021-03-29 21:21:29'),
(5, 'admin', 'novitadwicendaniraya12@gmail.com', 'oy, kenapai cika?', '2021-03-29 21:21:51');
...
CREATE TABLE `produk` (
  ...
  `fotob` varchar(225) NOT NULL,
  `fotoc` varchar(225) NOT NULL,
  `fotod` varchar(225) NOT NULL,
...
INSERT INTO `produk` (`id`, `item_desc`, `spesifikasi`, `foto`, `fotob`, `fotoc`, `fotod`, `harga`) VALUES
(20, 'tes gambar', 'spesifikasi tes gambar', '0013-Upload.png', '0002-baru.png', '0014-Korea-Reomit.png', '0015-Nissa-Sabyan.png', 2000),
(22, 'tes gambar 2', 'spek gambar 2', '0009.png', '0002-baru.png', '-', '0005.png', 100),
(23, 'tes gambar 3', 'spek gambar 3', '604fa7e93461e7-Portable-Space-40FT-HC-final.jpg', '604fa7e9346248d42dd4c34067aff84fb86519fa8d6df78d9da587f4fef84c60c7d3f5fef8e5d.jpg', '-', '-', 2000000),
(24, 'tes gambar 4', 'spesifikasinya teredit', '604faf650c1687-Portable-Space-40FT-HC-final.jpg', 'photo_2.jpg', '-', '-', 2000);
...
INSERT INTO `produk_log` (`id`, `id_user`, `id_produk`, `log_code`, `nama_perusahaan`, `alamat_perusahaan`, `kota`, `nama_surat`, `harga`, `terbilang`, `jenis_surat`, `status_log`, `date`, `ongkir`) VALUES
(432, 8, 20, '27032021210212', 'PT. Semlohay Asoy Coy', 'Jalan Ulala Beibih', 'D', '27032021210212.pdf', '2000', 'dua ribu dua ratus rupiah', 'Surat Permohonan', 'SELESAI', '27 March 2021', 0),
(433, 8, 20, '27032021210212', 'PT. Semlohay Asoy Coy', 'Jalan Ulala Beibih', 'D', 'SURAT PENAWARAN HARGA', '2000', 'dua ribu dua ratus rupiah', 'SURAT PENAWARAN HARGA', 'SELESAI', '27 March 2021', 0),
(434, 8, 20, '27032021210212', 'PT. Anugrah Teknik Mandiris', 'Komp. Ruko New Zamrud F.17 Jl. A.P. Pettarani Makassar ', 'Makassar', 'PO', '4000', 'dua ribu dua ratus rupiah', 'PO', 'SELESAI', '2021-03-27', 0),
(435, 8, 20, '27032021210212', 'PT. Anugrah Teknik Mandiris', 'Komp. Ruko New Zamrud F.17 Jl. A.P. Pettarani Makassar ', 'Makassar', 'INVOICE', '4000', 'empat ribu empat ratus rupiah', 'INVOICE', 'SELESAI', '27 March 2021', 250000),
(436, 8, 20, '27032021210212', 'PT. Anugrah Teknik Mandiris', 'Komp. Ruko New Zamrud F.17 Jl. A.P. Pettarani Makassar', 'Makassar', '27032021210212.png', '4000', 'empat ribu empat ratus rupiah', 'Surat Bukti Pembayaran', 'SELESAI', '27 March 2021', 0);
...
INSERT INTO `purchase_order` (`id`, `id_produk`, `price`, `qty`, `uom`, `total_harga`, `supplier_name`, `supplier_contact`, `supplier_address`, `supplier_contact_person`, `supplier_email`, `supplier_payment_terms`, `supplier_freight_terms`, `supplier_shipping_method`, `perusahaan_logo`, `perusahaan_nama`, `perusahaan_alamat`, `perusahaan_nomor_telp`, `perusahaan_provinsi`, `procurement_bu`, `req_bu`, `bill_to_location`, `default_ship_to_location`, `po_number`, `date`, `revision`, `buyer`, `Currency`, `status`, `description`, `first_approver`, `last_approver`, `spesifikasi`, `item_desc`, `delivery_date`) VALUES
(86, 20, 2000, 2, 'Unit', 4000, 'PT. Anugrah Teknik Mandiris', '(0411) 452455 ', 'Komp. Ruko New Zamrud F.17 Jl. A.P. Pettarani Makassar ', '(0411) 452455 ', 'anugerahtehnik_mandiri@yahoo.com', 'Supplier paymentnya', 'Supplier freightnya', 'Supplier Shippingnya', '', 'PT. Semlohay Asoy Coy', 'Jalan Ulala Beibih', '081234567890', 'Sulawesi Selatan', 'Procurement BU nya', 'Requisitioning BU nya', 'ahdasufhau', 'asjasuahdi', '27032021210212', '2021-03-27', 2, 'Syahrini', '15000', 'Mantap', 'Luar Biasa Mantap', 'Manusida yg Approve', 'Manusia yg Approve juga', 'spesifikasi tes gambar', 'tes gambar', '09-03-2021');
...
INSERT INTO `user_chat` (`id_user_chat`, `email`) VALUES
(2, 'novitadwicendaniraya@gmail.com'),
(3, 'novitadwicendaniraya12@gmail.com');
...
--
ALTER TABLE `user_chat`
  MODIFY `id_user_chat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
